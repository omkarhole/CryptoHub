    ...
    <>
      <div className="mb-10">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black mb-4 leading-tight">
          ...
          <svg
            className="inline-block ml-3 w-12 h-12 text-[#00d9ff]"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-6">
        ...
        >
          ...
          <div className="space-y-4">
            <div
              className={`pb-4 border-b ${isDark ? "border-[rgba(255,255,255,0.06)]" : "border-gray-200"}`}
            >
              <p
                className={`text-sm mb-1 ${isDark ? "text-gray-500" : "text-gray-600"}`}
              >
                Email
              </p>
              <p
                className={`font-semibold truncate ${isDark ? "text-gray-300" : "text-gray-900"}`}
              >
                {currentUser?.email}
              </p>
            </div>
          ...
          {topCoins.map((coin, index) => (
            ...
            >
              <div className="flex items-center gap-3">
                <span
                  className={`text-sm font-bold w-6 ${isDark ? "text-gray-500" : "text-gray-400"}`}
                >
                  #{index + 1}
                </span>
                <img
              ...
              <div className="text-right">
                ...
                <p
                  className={`text-sm ${(coin.price_change_percentage_24h || 0) > 0 ? "text-green-400" : "text-red-400"}`}
                >
