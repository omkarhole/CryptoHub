...
const Profile = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div
        className={`p-6 mb-6 rounded-2xl flex flex-col items-center justify-center ${sectionClasses}`}
      >
        <div
        ...
        >
          <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-[#00d9ff] shadow-[0_0_20px_rgba(0,217,255,0.3)]">
            {imagePreview ? (
              ...
              <div
                className={`w-full h-full flex items-center justify-center text-4xl font-bold ${isDark ? "bg-[#1a1a2e] text-gray-500" : "bg-gray-100 text-gray-400"}`}
              >
                {formData.fullName ? (
        ...
        <p
          className={`mt-4 text-sm font-medium ${isDark ? "text-gray-400" : "text-gray-500"}`}
        >
      ...
      >
        ...
        <div className={sectionClasses}>
          <div className="flex items-center gap-3 mb-6">
            <div
              className={`p-3 rounded-lg ${isDark ? "bg-blue-500/10 text-blue-400" : "bg-blue-50 text-blue-600"}`}
            >
              <FiUser size={20} />
            </div>
            <h2
        ...
        <div className={sectionClasses}>
          <div className="flex items-center gap-3 mb-6">
            <div
              className={`p-3 rounded-lg ${isDark ? "bg-purple-500/10 text-purple-400" : "bg-purple-50 text-purple-600"}`}
            >
              <FiActivity size={20} />
            </div>
            <h2
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div
                className={`p-4 rounded-xl border ${isDark ? "bg-[#1a1a2e] border-[rgba(255,255,255,0.05)]" : "bg-gray-50 border-gray-100"}`}
              >
