...
const MockMotion = ({ children, ...props }) => {
  return <div {...props}>{children}</div>;
};

vi.mock("framer-motion", () => ({
  motion: {
    div: (props) => MockMotion(props),
    button: (props) => MockMotion(props),
    section: (props) => MockMotion(props),
    h1: (props) => MockMotion(props),
    h2: (props) => MockMotion(props),
    p: (props) => MockMotion(props),
    form: (props) => MockMotion(props),
  },
